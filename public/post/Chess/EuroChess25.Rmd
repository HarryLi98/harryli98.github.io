...
knitr::include_graphics(
 "/img/eurochess25/polgarteam.jpg", error=FALSE
)
```
...
```{r, include=TRUE}
knitr::include_graphics(
 "/img/eurochess25/harle_rapid.jpg", error=FALSE
)
```
...
```{r, include=TRUE}
knitr::include_graphics(
 "/img/eurochess25/harry_blitzr1.jpg", error=FALSE
)
```
...
```{r, include=TRUE}
knitr::include_graphics(
 "/img/eurochess25/blitz_trophy.jpg", error=FALSE
)
```
...
```{r, include=TRUE}
knitr::include_graphics(
 "/img/eurochess25/polgarsimulplay.jpg", error=FALSE
)
```
